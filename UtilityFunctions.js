var SvgController = (function() {
	...
	var div = 'div';
	var btn = 'button';
	var popupBtnsClass = 'iconsvg';
	var addBtnClass = 'btn iconsvg'
	var optionsBtnsClass = 'btn prompt-btn custom-btn flex-auto ';
	var toolBtnClass = 'btn link-btn mini-tool';
	var dim32 = '"0 0 32 32"';
	var dim48 = '"0 0 48 48"';
	var dim64 = '"0 0 64 64"';
	var customStyles = ' " transform="translate(20) rotate(45) "'

	function getSvgElement(svg) {
		var el = document.createElement(svg.element);
		el.setAttribute('class', svg.className);
		el.innerHTML = '<svg viewBox=' + svg.dim + ' style="fill:currentcolor"><path d="'+ svg.path + svg.custom + '"></path></svg>';
		return el;
	}
